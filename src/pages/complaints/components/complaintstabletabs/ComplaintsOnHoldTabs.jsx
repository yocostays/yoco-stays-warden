...
import ComplaintsOnHoldTableContainer from "./ComplaintsOnHoldTableContainer";
  
  const ComplaintsOnHoldTabs = () => {
    ...
    return (
        ...
        <Box>
          <ComplaintsOnHoldTableContainer />
        </Box>
      </Box>
    );
  };
  
  export default ComplaintsOnHoldTabs;
