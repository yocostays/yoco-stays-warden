...
import ComplaintsWorkCompleteTableContainer from "./ComplaintsWorkCompleteTableContainer";
  
  const ComplaintsWorkCompleteTabs = () => {
    ...
    return (
        ...
        <Box>
          <ComplaintsWorkCompleteTableContainer />
        </Box>
      </Box>
    );
  };
  
  export default ComplaintsWorkCompleteTabs;
