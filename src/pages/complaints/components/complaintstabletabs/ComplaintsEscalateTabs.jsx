...
import ComplaintsEscalateTableContainer from "./ComplaintsEscalateTableContainer";
  
  const ComplaintsEscalateTabs = () => {
    ...
    return (
        ...
        <Box>
          <ComplaintsEscalateTableContainer />
        </Box>
      </Box>
    );
  };
  
  export default ComplaintsEscalateTabs;
