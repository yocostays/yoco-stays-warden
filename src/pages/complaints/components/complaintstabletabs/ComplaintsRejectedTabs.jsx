...
import ComplaintsRejectedTableContainer from "./ComplaintsRejectedTableContainer";
  
  const ComplaintsRejectedTabs = () => {
    ...
    return (
        ...
        <Box>
          <ComplaintsRejectedTableContainer />
        </Box>
      </Box>
    );
  };
  
  export default ComplaintsRejectedTabs;
