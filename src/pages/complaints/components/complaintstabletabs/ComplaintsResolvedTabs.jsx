...
import ComplaintsResolvedTableContainer from "./ComplaintsResolvedTableContainer";
  
  const ComplaintsTableResolvedContainer = () => {
    ...
    return (
        ...
        <Box>
          <ComplaintsResolvedTableContainer />
        </Box>
      </Box>
    );
  };
  
  export default ComplaintsTableResolvedContainer;
