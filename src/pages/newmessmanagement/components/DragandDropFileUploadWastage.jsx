...
export default function DragAndDropFile({ handleClose, fetchMealBookingHistory, scrollToSection }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`${apiUrl}/api/food-wastage/bulk-upload`, {
        method: "POST",
        body: formData,
        headers: {
